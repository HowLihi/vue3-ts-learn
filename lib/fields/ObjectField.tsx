...
export function retrieveSchema(
  ...
  if ('allOf' in schema) {
    try {
      resolveSchema = mergeAllOf({
        ...resolveSchema,
        allOf: resolveSchema.allOf,
      } as any) as Schema
    } catch (e) {
      console.warn('could not merge subschema in allOf:\n' + e)
      const { allOf, ...resolveSchemaWithoutAllOf } = resolvedSchema
      return resolveSchemaWithoutAllOf
    }
  }
  ...
  if (hasAdditionalProperties) {
    return stubExistingAdditonalProperties(resolvedSchema, rootSchema, formdata)
  }
...
export function stubExistingAdditonalProperties(
  schema: Schema,
  rootSchema: Schema = {},
  formData: any = {},
) {
  ...
  Object.keys(formData).forEach((key) => {
    ...
    if (schema.additionalProperties.hasOwnProperty('$ref')) {
      additionalProperties = retrieveSchema(
        {
          $refs: schema.additionalProperties['$ref'],
        },
        rootSchema,
        formData,
      )
